...
export default {
    ...
    async nextQuestion() {
      ...
      var CapRes = {
        ...
        Id_pregunta: this.idPregunta,
          ...
          const res = await this.$axios.post('https://saludlaboral6touaa-f8gccmcccghddqad.mexicocentral-01.azurewebsites.net/api/GuardarRespuestas', CapRes)
  ...
  async mounted() {
    ...
    console.log(this.CapturaRespuestas)
